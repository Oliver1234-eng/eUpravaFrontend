...
@Component({
  selector: 'app-pretraga-baze-podataka-katastra-nepokretnosti',
  templateUrl: './pretraga-baze-podataka-katastra-nepokretnosti.component.html',
  styleUrls: ['./pretraga-baze-podataka-katastra-nepokretnosti.component.css']
})
export class PretragaBazePodatakaKatastraNepokretnostiComponent implements OnInit {
