...
@Component({
  selector: 'app-pretraga-baze-podataka-katastra-nepokretnosti-notar',
  templateUrl: './pretraga-baze-podataka-katastra-nepokretnosti-notar.component.html',
  styleUrls: ['./pretraga-baze-podataka-katastra-nepokretnosti-notar.component.css']
})
export class PretragaBazePodatakaKatastraNepokretnostiNotarComponent implements OnInit {
  ...
  constructor(private nepokretnostiService: NepokretnostiService, private http: HttpClient, private router: Router) { }
