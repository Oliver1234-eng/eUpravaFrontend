...
import { StatistikaInfoCentra } from '../prikaz-godisnjih-statistika-info-centra/StatistikaInfoCentra';

@Component({
  selector: 'app-prikaz-godisnjih-statistika-info-centra-gradjanin',
  templateUrl: './prikaz-godisnjih-statistika-info-centra-gradjanin.component.html',
  styleUrls: ['./prikaz-godisnjih-statistika-info-centra-gradjanin.component.css']
})
export class PrikazGodisnjihStatistikaInfoCentraGradjaninComponent implements OnInit {
